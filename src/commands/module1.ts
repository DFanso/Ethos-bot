...
import OpenAI from 'openai';  // Adjusted import from 'openai'
...
async function generateOpenAIResponse(question: string): Promise<string> {
...
module.exports = {
    ...
    async execute(interaction: CommandInteraction) {
        ...
        await interaction.editReply(response); // Edit the original reply with the actual response
    },
};
