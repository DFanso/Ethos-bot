...
const MODULE_8_CHANNEL_ID = config.MODULE_8_CHANNEL_ID;
...
module.exports = {
  ...
  async execute(interaction: CommandInteraction) {
    ...
    if (interaction.channelId !== MODULE_8_CHANNEL_ID) {
        await (interaction as CommandInteraction).reply({
          content: `Can\'t use this command in this Channel!, Use this Channel: <#${MODULE_8_CHANNEL_ID}>`,
          ephemeral: true
        });
        return;
      }
